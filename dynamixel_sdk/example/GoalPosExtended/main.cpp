...
int main()
{
    ...
    // make torque control mode
   // DXL.WriteByte(1, LL_OPERATING_MODE, 0, 0);
    DXL.WriteByte(1, LL_OPERATING_MODE, 5, 0);
...
*/
    ...
    while(1)
    {
        ...
        DXL.WriteDWord(1, LL_GOAL_POSITION, ref, 0);
        usleep(CONTROL_PERIOD*500);

        DXL.WriteWord(1, LL_GOAL_CURRENT, 1000, 0);   //move to 9-o-clock position     
        usleep(CONTROL_PERIOD*100);
        ref += ref;
    }
